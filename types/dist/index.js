...
//Type Assertion
console.log(`\n`);
let taxNumberTa = calculateTax2(200, false);
let taxStringTa = calculateTax2(200, true);
let taxStringTa2 = calculateTax2(200, true); //2nd aproach
...
let taxBooleanTa = calculateTax2(200, true);
